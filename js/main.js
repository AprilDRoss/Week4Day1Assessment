...
/*************************************************************************************
------------ ANSWER -------------------
console.log(y): will return an error because the variable is defined after the console.log
...
/*************************************************************************************
------------ ANSWER -------------------
console.log(x): will give an error because x is defined after being consoled.
console.log(y): will give "function is undefined" because the function is declared after being consoled.
...
/**************************************************************************************
------------ ANSWER -------------------
inside the IFEE: console.log(add) will give a value of 4; the addition will be executed
outside the IFEE: console.log(add) will give a value of 4, because the addition will be executed
